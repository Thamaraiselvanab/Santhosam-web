      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
            className="relative rounded-2xl overflow-hidden max-w-lg mx-auto lg:mx-0"
          >
            <img 
              src={feedbackImg} 
          ...
          <div className="space-y-6">
            <motion.p 
              ...
              viewport={{ once: true }}
              className="text-[#EA1273] font-semibold text-lg uppercase tracking-wide"
            >
              Feedback
            </motion.p>
            ...
            <motion.h2 
              ...
              className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#003366] leading-tight"
            >
            ...
            <motion.div 
              ...
              className="bg-gray-50 p-6 md:p-8 rounded-3xl shadow-sm border border-gray-100 relative"
            >
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  <div>
                    <p className="font-bold text-gray-900 text-xl">{testimonials[activeIndex].name}</p>

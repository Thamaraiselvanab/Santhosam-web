      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden lg:flex items-center space-x-4">
            <button className="px-6 py-2 rounded-md border-2 border-[#EA1273] text-[#003366] font-bold text-sm bg-[#E3F2FD] hover:bg-white transition-all shadow-sm">
              Santhosam
            </button>
            <button className="px-6 py-2 rounded-md bg-[#EA1273] text-white font-bold text-sm hover:bg-[#D41068] transition-all shadow-md">
              Enquiry
            </button>
          </div>
